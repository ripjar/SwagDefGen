...
import convertBoolean, { BooleanYaml } from "./convertBoolean";
...
export type AnyYaml = ObjectYaml | NumberYaml | StringYaml | NullYaml | ArrayYaml | BooleanYaml;
...
export default function anyConversion(v: any, options: ConvertOptions): AnyYaml {
  ...
  if (typeof v === "boolean") return convertBoolean(v, options);
